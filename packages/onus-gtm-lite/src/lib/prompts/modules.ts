...
export const CITATION_RULE = `CITATION RULES:
- Knowledge-base claims: cite inline as \`[Doc title · p.N]\` matching the KB block provided.
- Recent news claims (market timing, competitive moves, announcements): cite inline as \`[Publisher · YYYY-MM-DD · headline]\` matching the news block provided.
- Prefer KB evidence for product positioning, personas, and internal GTM facts. Use news for timely market context only when supported by the news excerpts.
- If no evidence supports a claim, do not write it.`;
